...
def all(ctx, host, ansible_args='', build_igloo=False, force_build=False, skip_build=False):
    """
    Deploy all on provided host
    """
    extra_vars = {'playbook_host': host, 'playbook_build_igloo': build_igloo, 'playbook_force_build': force_build, 'playbook_skip_build': skip_build}
